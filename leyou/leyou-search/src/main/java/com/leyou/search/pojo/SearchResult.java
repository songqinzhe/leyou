...
public class SearchResult extends PageResult<Goods> {
    ...
    public SearchResult(Long total, Integer toyalPage, List<Goods> items, List<Map<String, Object>> categories, List<Brand> brands, List<Map<String, Object>> specs) {
        super(total, toyalPage, items);
        this.categories = categories;
        this.brands = brands;
        this.specs = specs;
    }
