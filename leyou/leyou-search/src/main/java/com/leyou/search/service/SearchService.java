...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        skus.forEach(sku -> {
            ...
            //获取sku中的图片，图片数据库中的图片可能是多张，多张是以“，”分隔，所以也以逗号来切割返回的数组，获取第一张图片
        ...
        //获取sku下的所有sku，并转化成json字符串  sku并不是所有字段都需要，
        //List<Map<id/title/price/image,Object>>
    ...
    private List<Brand> getBrandAggResult(Aggregation aggregation) {
        ...
        //List<Long> bids = new ArrayList<>();  //long 类型的数组
